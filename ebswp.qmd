...
document contents, including tables and figures is provided in
@sec-contents.
...
The NMFS acoustic-trawl survey (ATS) age composition data was revised
from the preliminary estimates developed in 2022. The BTS chartered
boats also collected acoustic data and the series was updated this year
(AVO). Explorations were presented in @ianelli2023.
...
-   the SSC requests that the author document the method used for determining
    ...
    -  *As with past assessments, we document how we chose a selectivity to assume for 
       projection purposes and provide more rationale and objectives in making this choice.*
...
offloading. Work continues on linking the log-book data withe the EM
...
observer sampling has resulted in a temporary hiatus in to associate
...
confirms the abundance year-class from 2018. We note that the center of
...
modeling (@indivero2023). This work was adopted in 2022 and values used
...
spacing between 172° W and the US-Russia maritime boundary." The areas
east of 170°W was surveyed from 11-22 June and west of 170°W was
surveyed from the 23rd of June through July 17.

The estimated amount of pollock in the core survey area in 2024 was 11.4
billion fish with a biomass of 2.87 million metric tons (t), a 25%
decrease from the estimate of 9.67 billion fish with a biomass of 3.8
million t in 2022. This was a 20% decrease from the 3.617 million t
estimated in 2020 by the acoustics-only Saildrone survey, and 10% below
the survey mean of 3.2 million tons for all surveys from 1994-2022.
...
about the stock-recruitment relationship (SRR), an alternative natural
mortality-at-age and year matrix (from the CEATTLE model results),
...
projected 14 years from `r thisyr` (\cref{tbl:tier3SSB} for Model
...
2023     &   xxxxx   &   5,817   &   2,240   &   1,858   &   531     &   506     &   15,814 \\
\hline
\end{tabular}
}
\end{table}
...
2023     &   xxx     &   776     &   616     &   558     &   209     &   211     &   2,978  \\
\hline
\end{tabular}
}
\end{table}
...
printfig("fsh_lw_anom_yr_box.png", 25)
printfig("fsh_wtage_comb.png", 20)
